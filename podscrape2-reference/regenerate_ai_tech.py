"""
Regenerate all AI and Technology digests with eleven_v3 model and narrative chunking.
"""
...
print("Finding all AI and Technology digests to regenerate...")
repo = get_digest_repo()

# Get all AI and Tech digests from the last 14 days
end_date = date.today()
...
while current_date <= end_date:
    ...
    all_digests.extend([d for d in digests if 'AI and Technology' in d.topic])
