...
import { signInWithGoogle, getSession } from '@/utils/supabase-auth'
...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      ...
      if (session?.user?.email === 'brownpr0@gmail.com') {
        router.push('/')
      }
    }
    checkAuth()
    ...
    if (errorParam === 'unauthorized') {
      setError('Access denied. Only brownpr0@gmail.com is authorized to use this application.')
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="text-center">
            <p className="text-xs text-gray-500">
              ...
              <br />
              Only brownpr0@gmail.com can access this system.
            </p>
          </div>
        </div>
      </div>
